...
//struct pair_2nd_cmp: public binary_function<bool, T1, T2> {
//    bool operator () (const pair <T1, T2>& x1, const pair<T1, T2> &x2)
//    {
...
//}
//
//bool SLGspan::can_prune_boost (Projected &projected, size_t mode)
//{
//    
//    double gain = 0;
//    double upos = 0;
...
//    string s = ostrs.str();
//    int id = da.exactMatchSearch (s.c_str());
//    
//    if (id == -2) return;
//    if (id >= 0) {
//        if (os)
//            rules.insert (make_pair<string, double> (s, alpha[id]));
//        result.push_back (id);
//    }
//    //    }
//    
...
//            if (e) new_bck_root[DFS_CODE[rmpath[i]].from][e->elabel].push (id,
//                                                                           e, cur);
//        }
//        
//        // pure forward
...
//        
//        size_t id = child->projected[n].id;
//        
...
//}
//
////  double gSpan::calc_gain (const vector <size_t> &loc)
////    {
////      double gain = - wbias;
...
////    }
//
//bool SLGspan::search(size_t _tasktype)
//{
//    tasktype = _tasktype;
//    
//    //    int verbose = 1;
...
//        //Projected projected;
//        //projected.clear();
//        //for (Projected::iterator pit = pre2->projected.begin () ; pit != pre2->projected.end() ; ++pit){
//        //projected.push(pit->id,pit->edge,pit->prev);
//        //}
//        
...
//    // cout << rule.gain << " " << rule.dfs << endl;}
//    
//    return true;
//}
//
//bool SLGspan::open (const char *file)
//{
//    if (! mmap.open (file)) return false;
//    
//    char *ptr = mmap.begin ();
//    size_t size = 0;
//    read_static<size_t>(&ptr, size);
//    da.setArray (ptr);
//    ptr += size;
//    read_static<double>(&ptr, bias);
//    read_static<size_t>(&ptr, alphaSize);
//    alpha = (double *)ptr;
//    return true;
//}
